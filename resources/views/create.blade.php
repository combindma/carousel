...
@section('title', 'Ajouter une carousel')
@push('head')
...
@section('content')
    <div class="max-w-7xl mx-auto px-4 py-10 sm:px-6 lg:px-8">
        <form id="form-action" action="{{ route('carousel::carousels.store') }}" method="POST" enctype="multipart/form-data">
